  ...
  \cventry
    ...
    {Sep. 2021 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Dedicated to opensource software development 200+ stars on GitHub (Subtitle Downloader: 1st page on Google search results, 1k+ views, 100+ clones))}
